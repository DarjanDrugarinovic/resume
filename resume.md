<table>
  <tr>
    <td><img src="profile.png" alt="Darjan Drugarinović" width="120" style="border-radius:50%" /></td>
    <td style="padding-left:20px; vertical-align:middle; text-align:center;">
      <h1 style="margin:0">Darjan Drugarinović</h1>
      <p style="margin:4px 0">Software Engineer · 5 Years' Experience</p>
    </td>
  </tr>
</table>

<div style="display:flex; justify-content:space-evenly;">
  <span>darjan.drugarinovic@gmail.com</span>
  <span>060 7154400</span>
...
- Displaying real-time sensor data with Next.js

**Petrol Market Access**

- Real-time electricity stock market platform built with Next.js

**Service Now**

- SaaS platform that automates processes within an organization
...
- Refactored and reorganized 2 years of legacy code, extracting common logic into shared modules
- Replaced Babel, Rollup, and Webpack with Vite
- Migrated the codebase from JavaScript to TypeScript

**React Component Library**
- Implemented reusable components used across multiple projects, improving UI consistency and reducing development time

**React Video Player**
- Set up project architecture and implemented complex timeline logic

**Unified Video**
- Worked with multiple concurrent video player instances
- Implemented features leveraging video data

Daily collaboration with international designers and developers; responsibilities included code reviews, project integration, and planning.
...
- APIs
- Setup a VPS hosting
- Defined app deployment through Github Actions
- Create documentation about running the app in both local and hosting environments, with or without Docker.

_Please check out **[spremiispit.com](https://spremiispit.com)**_
